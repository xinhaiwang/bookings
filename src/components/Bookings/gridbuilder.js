...
// The transformBookings function uses the reduce method to step through each booking in the array and
// build up the bookings lookup object, assigning the current booking to its allotted lookup slot.
